...
class Update():
	...
	def checkForUpdate(self):
		...
		response = requests.get(self.raw_version_url+'version.txt', verify=False, stream=True)
	...
	def update(self):
		response = requests.get(self.repo_url+self.online_version+'.zip', verify=False, stream=True)
